...
/* harmony import */ var _assests_toast_jpg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../assests/toast.jpg */ "./src/assests/toast.jpg");
/* harmony import */ var _assests_pancakes_jpg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../assests/pancakes.jpg */ "./src/assests/pancakes.jpg");
/* harmony import */ var _assests_fresh_fruits_jpg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../assests/fresh-fruits.jpg */ "./src/assests/fresh-fruits.jpg");
/* harmony import */ var _utilities_utilities_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utilities/utilities.js */ "./src/utilities/utilities.js");
...
function menuComponent(){
  ...
  function getMenuHeaderElement(){
    ...
    const img1 = new _utilities_utilities_js__WEBPACK_IMPORTED_MODULE_7__.CreateImageNode(_assests_bee1_png__WEBPACK_IMPORTED_MODULE_0__,'bee-image1');
    
    const menuHeader = document.createElement('div');
    menuHeader.classList.add('menu-name');
    menuHeader.textContent = `Menu`;

    const img2 = new _utilities_utilities_js__WEBPACK_IMPORTED_MODULE_7__.CreateImageNode(_assests_bee1_png__WEBPACK_IMPORTED_MODULE_0__,'bee-image2');
...
function createBeveragesSection(parentNode){
  ...
  const honeyTeaEle = new _utilities_utilities_js__WEBPACK_IMPORTED_MODULE_7__.CreateCard('Honey Tea','A warm, sweet tea made with the highest quality honey and a bit of lemon to start your day off right!','30 Rs',_assests_honeyTea_jpg__WEBPACK_IMPORTED_MODULE_2__);
  parentNode.append(honeyTeaEle.node);

  const berryTeaEle = new _utilities_utilities_js__WEBPACK_IMPORTED_MODULE_7__.CreateCard('Berry Tea','A comforting, almost filling, tea that is infused with the flavors of several kinds of berries. Best served cold, but can be served hot on request.','40 Rs',_assests_berryTea_jpg__WEBPACK_IMPORTED_MODULE_3__);
...
function createSidesSection(parentNode){
  ...
  const honeyTeaEle = new _utilities_utilities_js__WEBPACK_IMPORTED_MODULE_7__.CreateCard('Toast And jam','A slice of toast, your choice of bread, and our homemade blackberry or raspberry jam.','60 Rs',_assests_toast_jpg__WEBPACK_IMPORTED_MODULE_4__);
  parentNode.append(honeyTeaEle.node);

  const berryTeaEle = new _utilities_utilities_js__WEBPACK_IMPORTED_MODULE_7__.CreateCard('Fresh Fruits','A small bowl of fresh fruit, whatever we find at the market for the day.','50 Rs',_assests_fresh_fruits_jpg__WEBPACK_IMPORTED_MODULE_6__);
  parentNode.append(berryTeaEle.node);
}
...
function createMainDishesSection(parentNode){
  ...
  const panCakesEle = new _utilities_utilities_js__WEBPACK_IMPORTED_MODULE_7__.CreateCard('Pan Cakes','A stack of homemade buttermilk pancakes, served with our locally sourced maple syrup.','160 Rs',_assests_pancakes_jpg__WEBPACK_IMPORTED_MODULE_5__);
  parentNode.append(panCakesEle.node);

  const frenchToastEle = new _utilities_utilities_js__WEBPACK_IMPORTED_MODULE_7__.CreateCard('French Toast','Two slices of the best french toast you will ever eat, served with our locally sourced maple syrup.','150 Rs',_assests_toast_jpg__WEBPACK_IMPORTED_MODULE_4__);
  parentNode.append(frenchToastEle.node);

  const bearyVeggieSandwichEle = new _utilities_utilities_js__WEBPACK_IMPORTED_MODULE_7__.CreateCard('Beary Veggie Sandwich','Do you like vegetables? Then this is the sandwich for you! Stuffed full of a variety of fresh produce, it will fill you up.','260 Rs',_assests_toast_jpg__WEBPACK_IMPORTED_MODULE_4__);
  parentNode.append(bearyVeggieSandwichEle.node);

  const bagelAndLox = new _utilities_utilities_js__WEBPACK_IMPORTED_MODULE_7__.CreateCard('Bagel and Lox','Our house specialty, you cant go wrong with a hearty bagel topped with sustainably harvested salmon.','250 Rs',_assests_berryTea_jpg__WEBPACK_IMPORTED_MODULE_3__);
  parentNode.append(bagelAndLox.node);

  const honeyCombEle = new _utilities_utilities_js__WEBPACK_IMPORTED_MODULE_7__.CreateCard('Honeycomb','Are you a bear like us? Then you will love our honeycomb. And, yes humans, it is just a piece of honeycomb, not the popular breakfast cereal.','160 Rs',_assests_honeyTea_jpg__WEBPACK_IMPORTED_MODULE_2__);
  parentNode.append(honeyCombEle.node);

  const theBearyBestPorridgeEle = new _utilities_utilities_js__WEBPACK_IMPORTED_MODULE_7__.CreateCard('The Beary Best Porridge','Made by Baby Bear himself, this porridge is guarenteed to be just right, or your money back.','150 Rs',_assests_berryTea_jpg__WEBPACK_IMPORTED_MODULE_3__);
...
class CreateMenuCategory {
  ...
  img = new _utilities_utilities_js__WEBPACK_IMPORTED_MODULE_7__.CreateImageNode(_assests_honeycomb_png__WEBPACK_IMPORTED_MODULE_1__,'brev-honey-comb');
  constructor(label){
...
/***/ "./src/assests/fresh-fruits.jpg":
/*!**************************************!*\
  !*** ./src/assests/fresh-fruits.jpg ***!
  \**************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "c49dd0e549250486823f.jpg";
...
/***/ "./src/assests/pancakes.jpg":
/*!**********************************!*\
  !*** ./src/assests/pancakes.jpg ***!
  \**********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "31fcec98fa1bb51f5df8.jpg";

/***/ }),

/***/ "./src/assests/toast.jpg":
/*!*******************************!*\
  !*** ./src/assests/toast.jpg ***!
  \*******************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "5a29d7965ed2fb916a6c.jpg";
